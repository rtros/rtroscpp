#ifndef RTAI_THREAD_SHARED_MUTEX_HPP
#define RTAI_THREAD_SHARED_MUTEX_HPP
...
namespace rtai_thread
{
    ...
    private:
        ...
        state_data state;
        rtai_thread::mutex state_change;
        rtai_thread::condition_variable shared_cond;
        rtai_thread::condition_variable exclusive_cond;
        rtai_thread::condition_variable upgrade_cond;
...
#endif
            boost::unique_lock<rtai_thread::mutex> lk(state_change);
